...
### Para pensar
<center>
Se estivéssemos num contexto de previsão, qual dos dois (unidirecinal ou bidirecional) seria uma abordagem mais apropriada? Por que? 
</center>
:::
...
[O valor de $m$ determina quão suavizada será a série. Um valor de $m$ pequeno, é geralmente utilizado para dimunuir um pouco o ruido (pequenas oscilações devidas à aleatoriedade). O restante das oscilações é devido, geralmente, a pdrões sazonais ou tendência-ciclo da série.]{style="color:violet;"}
</center>
