...
Processo MA(q) são úteis para descrever fenômenos nos quais acontecimentos produzem um efeito immediato que duram apenas por curtos períodos de tempo.



. . . 

> Assim como no caso dos AR(p), a PACF também será útil para identificarmos o processo.
...
$$\phi_{kk} = \dfrac{\phi_1^k(1 - \phi_2^2)}{1 - \phi_2^{k+1}}, \quad k \geq 1.$$
