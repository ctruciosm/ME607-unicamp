...
- Para superar estas limitações, surgiram os modelos de suavização exponencial. A ideia principal destes modelos é permitir com que os últimas observações da série tenham um maior peso nas previsões do que as observações mais antigas.
